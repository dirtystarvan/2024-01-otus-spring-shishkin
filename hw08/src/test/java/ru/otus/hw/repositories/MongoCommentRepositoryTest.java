...
class MongoCommentRepositoryTest {
    ...
    private Book persistTestBook() {
        ...
        var testBook = new Book("testBook", persistedAuthor, List.of(persistedGenre));
